			...
			<div class="w-full my-6 text-md">
				...
				<div class="hidden md:block float-right ml-2 mb-3">
					<a href="{{ $organisation->website }}" target="_blank" rel="noopener">
						<img class="md:w-72 lg:w-84" src="{{ $page->baseUrl }}/assets/images/{{ $status }}/carousel/{{ $organisation->logo }}.svg" alt="Logo : {{ $organisation->name }} ">
					</a>		
				</div>
				...
				<div class="md:hidden">
					<a href="{{ $organisation->website }}" target="_blank" rel="noopener">
						<img class="w-64 mx-auto" src="{{ $page->baseUrl }}/assets/images/{{ $status }}/carousel/{{ $organisation->logo }}.svg" alt="Logo : {{ $organisation->name }} ">
					</a>		
				</div>
