@extends('_layouts.master', 
	...
	<main class="relative bg-white w-full z-10">
		...
		@include('_components.title-component', ['title' => 'Get in touch', 'background_image' => 'header-b'])

		<section class="container mx-auto mt-6 flex flex-wrap">

			<div class="w-full flex flex-col p-4 w-full lg:w-1/3">
				<div class="contact-a h-48 bg-cover overflow-hidden border-b-4 border-red-pigment-500 rounded-t-md"></div>
				<div class="flex flex-col px-4 md:px-10 py-6 bg-gray-800 text-white rounded-b-md">
					<div class="flex-1 text-center">
						...
						<div class="mt-4 text-md">
							<div class="font-semibold">Brian Sims</div>
							<div>Security Matters Editor</div>
			...
			<div class="w-full flex flex-col p-4 w-full lg:w-1/3">
				<div class="contact-b h-48 bg-cover overflow-hidden border-b-4 border-red-pigment-500 rounded-t-md"></div>
			...
			<div class="w-full flex flex-col p-4 w-full lg:w-1/3">
				<div class="contact-c h-48 bg-cover bg-center overflow-hidden border-b-4 border-red-pigment-500 rounded-t-md"></div>
				<div class="flex flex-col px-4 md:px-10 py-6 bg-gray-800 text-white rounded-b-md">
					<div class="flex-1 text-center">
						<h2 class="text-lg font-bold leading-snug uppercase">General Event Enquirires</h2>
						<div class="mt-4 text-md">
			...
			<div class="w-full flex flex-col py-4 px-4 md:w-1/2">
				<div class="flex flex-col flex-1 px-4 py-4 bg-white rounded-md bg-gray-300">
					<div class="md:mt-6 text-center font-bold text-lg tracking-tight font-semibold uppercase xl:mt-8 xl:text-xl">
						The 2022 FSM Awards are organised by
					</div>
							...
							<div class="mt-8">
								<div class="flex">
				                    <div class="inline-block w-4 h-4 mr-3 pt-1">                       
				                       <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" class="fill-current text-red-pigment-500"><path d="M8 20H3V10H0L10 0l10 10h-3v10h-5v-6H8v6z"/></svg>
				                    </div>
				                ...
				                <div class="inline-flex items-center mt-2">
				                    <svg class="mr-3 w-4 h-4 text-red-pigment-500" fill="currentColor" viewBox="0 0 20 20">                               
				                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" class="fill-current text-red-pigment-500"><path d="M20 18.35V19a1 1 0 0 1-1 1h-2A17 17 0 0 1 0 3V1a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v4c0 .56-.31 1.31-.7 1.7L3.16 8.84c1.52 3.6 4.4 6.48 8 8l2.12-2.12c.4-.4 1.15-.71 1.7-.71H19a1 1 0 0 1 .99 1v3.35z"/></svg>
				                    </svg>                        
