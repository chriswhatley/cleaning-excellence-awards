<!-- Footer -->
<footer class="relative w-full bg-onyx-600">
            ...
            <ul class="mt-8">
                ...
                <li>
                    <div class="inline-flex items-center">
                        ...
                        <a href="/nominate" class="footer-link">Make a nomination</a>
                    </div>                 
                </li>
                <li>
                    <div class="inline-flex items-center">
                        ...
                        <a href="{{ $page->registerURL }}" class="footer-link">Tickets</a>
                    </div>                 
                </li>
                <li>
                    <div class="inline-flex items-center">
	...
	<!-- Small Print -->
	<div class="bg-onyx-700 font-semibold">
